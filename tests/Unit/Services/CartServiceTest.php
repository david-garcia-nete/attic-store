...
class CartServiceTest extends TestCase
{
    ...
    public function test_totals_calculates_subtotal_and_grand_total(): void
    {
        ...
        $v1 = ProductVariant::factory()->for($product)->create(['price' => 6.00, 'weight_oz' => 10]);
        $v2 = ProductVariant::factory()->for($product)->create(['price' => null, 'weight_oz' => 6]);
        ...
        $this->assertSame(8.99, (float) $totals['shipping_total']);
        $this->assertEquals(2.0, (float) $totals['tax_total']);
        $this->assertEquals(39.49, (float) $totals['grand_total']);
        $this->assertSame(38, $totals['total_weight_oz']);
    }
}
